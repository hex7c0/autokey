...
AUTOKEY.prototype.encodeString = function(str, input_encoding, output_encoding) {
    ...
    return body(out, this.key.slice(0)).toString(output_encoding || 'binary');
};
/**
...
AUTOKEY.prototype.decodeString = function(str, input_encoding, output_encoding) {
    ...
    var out = new Buffer(str, input_encoding || 'binary');
    return body(out, this.key.slice(0), true).toString(output_encoding || 'binary');
};
/**
